...
const ConfirmButton = ({ className = 'btn-primary', Size = '', Text = 'Great!', Icon = 'thumbs-up', ...rest }) => {
...
const CancelButton = ({ className = 'btn-secondary', Size = '', Text = '', Icon = 'thumbs-down', ...rest }) => {
    className = `btn ${className} ${Size}`.trim();
    return (
        <button className={className} {...rest}>
            <FontAwesomeIcon icon={Icon} /> {Text}
        ...
        return (
            <div className={defaultClassName}>
                ...
                <div className="d-flex justify-content-center">
                    <ConfirmButton Text="Great!" onClick={this.confirmButtonHandler} Size="btn-lg" className="btn-primary mr-2" />
...
const AddToCartFunction = ({ className = '', Item, ...rest }) => {
