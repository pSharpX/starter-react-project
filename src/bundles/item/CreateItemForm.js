        ...
        return (
            <div className="p-3 bg-white rounded box-shadow">
                <h6 className="border-bottom border-gray pb-2 mb-0">
                    <FontAwesomeIcon icon="plus-square" className="mr-2"></FontAwesomeIcon>
                    <span>Producto</span>
                </h6>
                <div className="pt-3">
                    <form id="form"
                        ...
                        <div className="form-group">
                            ...
                            <small id="nameHelp" className="form-text text-muted">We'll
                        ...
                        <div className="form-group">
                            ...
                            <input id="description"
                                ...
                                onChange={this.handleChange} />
                            <small id="descriptionHelp" className="form-text text-muted">We'll
                                never share your email with anyone else.</small>
                            <span className="d-block invalid-feedback" htmlFor="description"></span>
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            ...
                            <input id="price"
                                ...
                                value={item.price}
                                onChange={this.handleChange} />
                            <span className="d-block invalid-feedback" htmlFor="precio"></span>
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <div className="input-group">
                                ...
                                <div className="input-group-append">
                                    ...
                                    <button type="button" className="btn btn-primary" onClick={(event) => (this.fileInput.current.click())}>
                            ...
                            <BoxImagePreviewer className="container mt-3">
                                {(item.image && item.image.name)
                                    ...
                                    : <div><FontAwesomeIcon icon="file-upload" size="2x" className="mr-2" />Choose an image</div>}
                            </BoxImagePreviewer>
                        </div>
                        <div className="form-group">
                            <button type="button"
                                ...
                                Cancel<FontAwesomeIcon icon="redo" className="ml-2"></FontAwesomeIcon>
                            </button>
                            <button type="submit" className="btn btn-outline-primary">
                                Save<FontAwesomeIcon icon="save" className="ml-2"></FontAwesomeIcon>
                            </button>
                        </div>
                    </form>
                </div>
